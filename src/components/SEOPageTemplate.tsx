...
import { setLeadSource, gtagEvent, trackWhatsAppClick, trackPhoneClick } from "@/lib/leadTracking"
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-40">
        <a href="https://wa.me/4917632333561" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all hover:scale-110" onClick={() => trackWhatsAppClick()}>
        ...
        <a href="tel:+4917632333561" className="bg-orange-600 hover:bg-orange-700 text-white rounded-full p-4 shadow-lg transition-all hover:scale-110" onClick={() => trackPhoneClick()}>
